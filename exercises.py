...
hobby = "PC gaming"
print(hobby)
role_model ="Maya Angelou"
print(role_model)
famous_quote = '"You will face many defeats in life, but never let yourself be defeated."'
print(famous_quote)
...
fav_color ="blue"
print(fav_color)
fav_song ="Hotel California by the Eagles"
print(fav_song)
...
my_hero= "My hero is " + role_model + " and her famous qoute is " + famous_quote + "."
print(my_hero)
...
#Declare variables named age, weight, shoe_size, fav_number, yen_rate, bitcoin_value, todays_temperature, hawaii_population, countries_traveled, number_of_siblings
...
fab_five = ["bacon", "ice cream", "oreos", "nutter butter", "melona bars"]
print(fab_five)
...
plate_lunch = ["kalbi", "meat jun", "korean fried chicken", "steak", "loco moco"]
print(plate_lunch)
...
ice_cream  = ["gold medal ribbon", "reeses", "pralines and cream"]
print(ice_cream)
...
west_siiiiide = ["Oregon", "California", "Washington", "Idaho", "Nevada"]
...
dynamic_duos = [["gin", "tonic"], ["peanut butter", "jelly"], ["milkshake", "cheeseburger"]]
...
vics_list = ['Hendricks gin', 'Fever Tree tonic', 'Costco pub mix', 'carot cake', 'oreos', 'Safeway fried chicken', 'Morning Glass coffee']
print(vics_list)
...
bucket_list = {}
bucket_list['travel'] = 'Phillipines'
bucket_list['learn'] = 'Cyber Secruity'
bucket_list['weight'] = 200
bucket_list['to_dos'] = ['Walk on the Great Wall', 'Ride a water buffalo in the Phillipines','Eat street food in Singapore']
bucket_list['meet_person'] = 'Alina Li'
print(bucket_list)
